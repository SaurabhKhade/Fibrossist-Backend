        ...
        <body>
          ...
          >
            <div style="margin: 50px auto; width: 70%; padding: 20px 0">
              ...
              <p>
                To proceed further and recover your account, You must verify your email first. 
                Use the OTP given below to verify your email. It is valid for 10 minutes only.
              </p>
              <a
                style="text-decoration: none"
              >
